...
| **Scratch tickets** | Optional family-controlled scratch tickets have a configurable cost, per-child weekly limit, transparent outcomes, and no loss below the lower balance limit. |
