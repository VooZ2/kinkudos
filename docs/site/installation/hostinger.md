...
description: Deploy KinKudos 26.6.1 with Hostinger Docker Manager, the managed Traefik reverse proxy, HTTPS, and a persistent named volume.
---
...
The KinKudos Compose definition uses the public `vooz2/kinkudos:26.6.1` image
...
It defines the `app` service, the `vooz2/kinkudos:26.6.1` image, the Hostinger
