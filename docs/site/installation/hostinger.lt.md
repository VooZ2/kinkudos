...
description: Įdiekite KinKudos 26.6.1 naudodami Hostinger Docker Manager, valdomą Traefik atvirkštinį tarpinį serverį, HTTPS ir nuolatinį named volume.
---
...
failas iš `26.6.1` leidimo.

KinKudos Compose aprašas naudoja viešą `vooz2/kinkudos:26.6.1` atvaizdą ir
...
```text
https://raw.githubusercontent.com/VooZ2/kinkudos/v26.6.1/deploy/hostinger/compose.yaml
```

Tą patį failą galite peržiūrėti
[GitHub](https://github.com/VooZ2/kinkudos/blob/v26.6.1/deploy/hostinger/compose.yaml).
Jame aprašyta `app` paslauga, `vooz2/kinkudos:26.6.1` atvaizdas, Hostinger
