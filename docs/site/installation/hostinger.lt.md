...
description: Įdiekite KinKudos 26.6.0 naudodami Hostinger Docker Manager, valdomą Traefik atvirkštinį tarpinį serverį, HTTPS ir nuolatinį named volume.
---
...
failas iš `26.6.0` leidimo.

KinKudos Compose aprašas naudoja viešą `vooz2/kinkudos:26.6.0` atvaizdą ir
...
Jame aprašyta `app` paslauga, `vooz2/kinkudos:26.6.0` atvaizdas, Hostinger
