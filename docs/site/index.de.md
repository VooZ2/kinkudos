---
title: KinKudos-Dokumentation — Schnellstart und Installation
description: Prüfen Sie, ob KinKudos zu Ihrer Familie passt, installieren Sie die selbst gehostete App und richten Sie die erste Familie ein.
hide:
  - toc
---

# KinKudos-Dokumentation

Der Schnellstart erklärt, wie Sie KinKudos auf einem eigenen Server installieren
und die erste Familie sicher einrichten.
...
- [Was ist KinKudos?](start/what-is-kinkudos.de.md)
- [Passt KinKudos zu Ihrer Familie?](start/is-kinkudos-right.de.md)
- [Was Selbsthosting bedeutet](start/what-self-hosting-means.de.md)
- [Auf einem vorbereiteten Docker-Server installieren](installation/guided-installer.de.md)
