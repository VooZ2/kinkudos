...
Laukiančių prašymų skydelyje visada yra antraštė **Laukiantys prašymai**. Kai
yra prašymų, šalia antraštės rodomas skaičiaus ženklelis. Kai prašymų nėra,
...
- pagrindiniai veiksmai **Pridėti** ir **Paskirti** bei **Daugiau**.

Kreditas ir bilietai rodomi kairėn lygiuotose atskirose eilutėse; tarp jų nėra
vidurio taško (`·`) skyriklio.
...
<img class="screenshot-image" src="../../assets/parent-home-child-cards-mobile-26-6-7.png" alt="Tėvų Pradžios vaikų kortelės su veiksmais Pridėti, Paskirti ir Daugiau telefone" loading="lazy">
</details>
...
Pagrindinėje eilutėje rodomi du pažymėti veiksmai ir valdiklis **Daugiau**.
...
**Daugiau** atveria trumpą dialogą **Daugiau veiksmų**. Tik ikoną turintys
valdikliai savo veiksmą pateikia patarime ir prieinamame ženkle. Šeimai skirtoje
dokumentacijoje nepasikliaujama ikonų forma.
...
Kai tvirtinamas taupymo tikslo pasiūlymas, kuriam dar reikia taupymo būdo,
