# Points, penalties, and corrections

Every point change creates a separate History entry. That record is not an
editable balance sheet: if something was wrong, add a clear correction instead
of rewriting the past.

> **For:** Parents<br>
> **Result:** The family can understand why a balance changed
...
3. Confirm, then verify the new entry in **Parents → History**.
