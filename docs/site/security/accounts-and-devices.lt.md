# Paskyros ir įrenginiai

Kiekvienas suaugusysis turi naudoti atskirą slaptažodžiu apsaugotą tėvų paskyrą. Kiekvienas vaikas turi profilį ir PIN, tačiau vaiko PIN veikia tik [susietame įrenginyje](../start/pair-a-child-device.lt.md).
