...
class AccessAndWorkflowTests(TestCase):
    ...
    def test_changelog_is_public_and_paginates_release_history(self):
        ...
        self.assertEqual(current_release["version"], "26.7.3")
        ...
        self.assertNotContains(next_page, "<h2>v26.7.3</h2>", html=False)
    ...
    def test_manifest_and_service_worker_are_available(self):
        ...
        self.assertContains(
            home,
            '/static/icons/favicon-32.png?v=26.7.3',
        )
        self.assertContains(home, "/static/css/app.css?v=26.7.3")
        self.assertContains(home, "/static/js/app.js?v=26.7.3")
        ...
        self.assertEqual(
            ...
            "/static/icons/icon-192.png?v=26.7.3",
        )
        worker = self.client.get(reverse("service_worker"))
        self.assertEqual(worker.status_code, 200)
        self.assertContains(worker, "/static/icons/icon-192.png?v=26.7.3")
