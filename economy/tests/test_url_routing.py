...
CANONICAL_EXAMPLES = {
    ...
    "caregiver_invite_redeem": "/guest-invite/",
    "caregiver_create_pin": "/guest-invite/pin/",
    "caregiver_login": "/guest/ABCD1234/",
    "child_select": "/child/",
    ...
    "parent_create_caregiver_invite": "/parents/guests/invite/",
    "parent_cancel_caregiver_invite": "/parents/guests/invites/27/cancel/",
    "parent_remove_caregiver": "/parents/guests/28/remove/",
    "parent_unlock_caregiver": "/parents/guests/28/unlock/",
...
def _args_for(name):
    args = {
        ...
        "caregiver_login": ["ABCD1234"],
        "parent_cancel_caregiver_invite": [27],
        "parent_remove_caregiver": [28],
        "parent_unlock_caregiver": [28],
