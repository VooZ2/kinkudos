...
urlpatterns = [
    ...
    path(
        "guest-invite/",
        caregiver_invite_redeem,
        name="caregiver_invite_redeem",
    ),
    path(
        "guest-invite/pin/",
        caregiver_create_pin,
        name="caregiver_create_pin",
    ),
    path(
        "guest/<str:login_code>/",
        caregiver_login,
        name="caregiver_login",
    ),
    ...
    path(
        "parents/guests/invite/",
        parent_create_caregiver_invite,
        name="parent_create_caregiver_invite",
    ),
    path(
        "parents/guests/invites/<int:invite_id>/cancel/",
        parent_cancel_caregiver_invite,
        name="parent_cancel_caregiver_invite",
    ),
    path(
        "parents/guests/<int:caregiver_id>/remove/",
        parent_remove_caregiver,
        name="parent_remove_caregiver",
    ),
    path(
        "parents/guests/<int:caregiver_id>/unlock/",
        parent_unlock_caregiver,
        name="parent_unlock_caregiver",
    ),
    path(
