...
from economy.auth import current_child, ensure_media_accessible, parent_account_required
...
def feedback_screenshot(request, report_id):
    ...
    ensure_media_accessible(request, report.child, require_child_session=True)
